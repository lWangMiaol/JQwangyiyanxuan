define(["jquery"], function($){
    ...
    function costumeTag(){
        ...
        $("#costumeChild_banner ol").find("li").eq(0).css({
            background: "#a7936e"
        })
        ...
        timer = setInterval(function(){
            ...
            bannerMove("#costumeChild_banner", iNum);

            

            //显示对应的ol li
            bannerOl("#costumeChild_banner", iNum);
        ...
        //移入banner_left容器暂停
        $("#costumeChild_banner").on("mouseenter", "ul", function(){
            clearInterval(timer);
            //显示对应的ol li
            bannerOl("#costumeChild_banner", iNum);
        ...
        //点击右箭头下标递增
        $(".costume_moveBtn_right").on("click", function(){
            clearInterval(timer);
            iNum++;
            if(iNum > 1){
                iNum = 0;
        ...
        //点击左箭头下标递减
        $(".costume_moveBtn_left").on("click", function(){
            clearInterval(timer);
        ...
        //移入ol li显示对应下标图片
        $("#costumeChild_banner ol").on("mouseenter", "li", function(){
