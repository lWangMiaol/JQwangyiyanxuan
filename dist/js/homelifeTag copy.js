define(["jquery"], function($){
    ...
    function homelifeTag(){
        ...
        $("#homelifeChild_banner ol").find("li").eq(0).css({
            background: "#a7936e"
        })
        ...
        timer = setInterval(function(){
            ...
            bannerMove("#homelifeChild_banner", iNum);

            

            //显示对应的ol li
            bannerOl("#homelifeChild_banner", iNum);
        ...
        //移入banner_left容器暂停
        $("#homelifeChild_banner").on("mouseenter", "ul", function(){
            clearInterval(timer);
            //显示对应的ol li
            bannerOl("#homelifeChild_banner", iNum);
        ...
        //点击右箭头下标递增
        $(".homelife_moveBtn_right").on("click", function(){
            clearInterval(timer);
            iNum++;
            if(iNum > 3){
                iNum = 0;
        ...
        //点击左箭头下标递减
        $(".homelife_moveBtn_left").on("click", function(){
            clearInterval(timer);
        ...
        //移入ol li显示对应下标图片
        $("#homelifeChild_banner ol").on("mouseenter", "li", function(){
