define(["jquery"], function($){
    ...
    function goodsBannerTag(){
        ...
        timer = setInterval(function(){
            ...
            bannerMove("#Banner", iNum);

            

            //显示对应的ol li
            bannerOl("#Banner_moveBtn_left", iNum);
        ...
        //移入banner_left容器暂停
        $("#Banner").on("mouseenter", "ul", function(){
            clearInterval(timer);
            //显示对应的ol li
            bannerOl("#Banner", iNum);
        ...
        //点击右箭头下标递增
        $(".Banner_moveBtn_right").on("click", function(){
            clearInterval(timer);
            iNum++;
            if(iNum > 3){
                iNum = 0;
        ...
        //点击左箭头下标递减
        $(".Banner_moveBtn_left").on("click", function(){
            clearInterval(timer);
