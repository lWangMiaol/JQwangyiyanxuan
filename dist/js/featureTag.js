define(["jquery"], function($){
    ...
    function featureTag(){
        ...
        $("#featureChild_banner ol").find("li").eq(0).css({
            background: "#a7936e"
        })
        ...
        timer = setInterval(function(){
            ...
            bannerMove("#featureChild_banner", iNum);

            

            //显示对应的ol li
            bannerOl("#featureChild_banner", iNum);
        ...
        //移入banner_left容器暂停
        $("#featureChild_banner").on("mouseenter", "ul", function(){
            clearInterval(timer);
            //显示对应的ol li
            bannerOl("#featureChild_banner", iNum);
        ...
        //点击右箭头下标递增
        $(".feature_moveBtn_right").on("click", function(){
            clearInterval(timer);
            iNum++;
            if(iNum > 2){
                iNum = 0;
        ...
        //点击左箭头下标递减
        $(".feature_moveBtn_left").on("click", function(){
            clearInterval(timer);
        ...
        //移入ol li显示对应下标图片
        $("#featureChild_banner ol").on("mouseenter", "li", function(){
